...
<html>
    <head>
        ...
        @section('scripts')
            ...
            @if ($siteConfiguration['arix']['advanced']['adminTheme'])
        ...
        <style>
            ...
            :root {
                --radiusInput: {{ $siteConfiguration['arix']['styling']['radiusInput'] }}px;
                --radiusBox: {{ $siteConfiguration['arix']['styling']['radiusBox'] }}px;

                --primary: rgb({{ $siteConfiguration['arix']['colors']['dark']['primary'] }});
                --primary-border: color-mix(in srgb, var(--primary) 75%, white 25%);

                --header: rgb({{ $siteConfiguration['arix']['colors']['dark']['gray100'] }});

                --text: rgb({{ $siteConfiguration['arix']['colors']['dark']['gray200'] }});
                --text-secondary: rgb({{ $siteConfiguration['arix']['colors']['dark']['gray300'] }});

                --box: rgb({{ $siteConfiguration['arix']['colors']['dark']['gray700'] }});
                --box-header: rgb({{ $siteConfiguration['arix']['colors']['dark']['gray700'] }});

                --active-border: rgb({{ $siteConfiguration['arix']['colors']['dark']['gray500'] }});
                --active: rgb({{ $siteConfiguration['arix']['colors']['dark']['gray600'] }});

                --input: rgb({{ $siteConfiguration['arix']['colors']['dark']['gray600'] }});
                --input-border: rgb({{ $siteConfiguration['arix']['colors']['dark']['gray500'] }});

                --sidebar: rgb({{ $siteConfiguration['arix']['colors']['dark']['gray700'] }});

                --background: rgb({{ $siteConfiguration['arix']['colors']['dark']['gray800'] }});
            }
        </style>
    </head>
